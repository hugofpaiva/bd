...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= HUGOPAIVA450A;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void SubmitContact(Contact C)
        {
            ...
            cmd.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, " + "City, Region, PostalCode, Country) " + "VALUES (@CustomerID, @CompanyName, @ContactName, @Address, " + "@City, @Region, @PostalCode, @Country, @tel, @FAX) ";
        ...
        private void UpdateContact(Contact C)
        {
            ...
            cmd.CommandText = "UPDATE Customers " + "SET CompanyName = @CompanyName, " + "    ContactName = @ContactName, " + "    Address = @Address, " + "    City = @City, " + "    Region = @Region, " + "    PostalCode = @PostalCode, " + "    Country = @Country, Phone = @tel, Fax = @FAX " + "WHERE CustomerID = @CustomerID";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@CustomerID", C.CustomerID);
            cmd.Parameters.AddWithValue("@CompanyName", C.CompanyName);
            cmd.Parameters.AddWithValue("@ContactName", C.ContactName);
